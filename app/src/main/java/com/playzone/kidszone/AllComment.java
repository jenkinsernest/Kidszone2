...
import com.playzone.kidszone.adaptors.AllCommentAdapter;
...
public class AllComment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        method = new database.Method(AllComment.this);
    ...
    public void getComment(String bookId, String userId) {
        ...
        JsonObject jsObj = (JsonObject) new Gson().toJsonTree(new database.API(AllComment.this));
