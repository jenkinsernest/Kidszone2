...
import com.playzone.kidszone.adaptors.BookAdapterGV2;
import com.playzone.kidszone.adaptors.BookAdapterLV2;
...
import database.EndlessRecyclerViewScrollListener;
...
public class RelatedBook extends AppCompatActivity {
    ...
    private BookAdapterLV2 bookAdapterLV;
    private BookAdapterGV2 bookAdapterGV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onClick = (position, type, id, subId, title, fileType, fileUrl, otherData) ->
                startActivity(new Intent(RelatedBook.this, BookDetail.class)
                        ...
                        .putExtra("type", type));
        method = new database.Method(RelatedBook.this, onClick);
    ...
    public void bookLV() {
        ...
        JsonObject jsObj = (JsonObject) new Gson().toJsonTree(new database.API(RelatedBook.this));
                    ...
                    if (bookRP.getStatus().equals("1")) {
                        ...
                        if (bookAdapterLV == null) {
                            if (bookRP.getBookLists().size() == 0) {
                                ...
                                bookAdapterLV = new BookAdapterLV2(RelatedBook.this, bookLists, "related_book", onClick);
                    ...
                    if (bookRP.getStatus().equals("1")) {
                        ...
                        if (bookAdapterGV == null) {
                            if (bookRP.getBookLists().size() == 0) {
                                ...
                                bookAdapterGV = new BookAdapterGV2(RelatedBook.this, bookLists, "related_book", onClick);
