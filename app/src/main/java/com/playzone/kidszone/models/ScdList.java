...
public class ScdList implements Serializable {
    ...
    public ScdList(String id, String book_title, String book_description, String book_cover_img, String book_bg_img, String book_file_type, String book_file_url, String total_rate, String rate_avg, String book_views, String author_name, List<SubCategoryList> subCategoryLists, List<CommentList> commentLists) {
        this.id = id;
