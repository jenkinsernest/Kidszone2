...
public class BookAdapterGV2 extends RecyclerView.Adapter<BookAdapterGV2.ViewHolder> {
    ...
    public BookAdapterGV2(Activity activity, List<SubCategoryList> subCategoryLists, String type, InterstitialAdView interstitialAdView) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.latest_gridview_adapter2, parent, false);
