...
public class AboutUsList implements Serializable {
    ...
    private String app_name,app_logo,app_version,app_author,app_contact,app_email,app_website,app_description,app_privacy_policy,publisher_id,interstital_ad_id,interstital_ad_click,banner_ad_id;
    private boolean interstital_ad=false;
    private boolean banner_ad=false;

    public AboutUsList(String app_name, String app_logo, String app_version, String app_author, String app_contact, String app_email, String app_website, String app_description, String app_privacy_policy, String publisher_id, String interstital_ad_id, String interstital_ad_click, String banner_ad_id, boolean interstital_ad, boolean banner_ad) {
